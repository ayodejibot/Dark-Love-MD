  ...
  try {
    ...
    wasi_bot.send = async (
      ...
      switch (_0xb61629.toLowerCase()) {
        ...
        case "":
          {
            return await Darklove_grop.sendMessage(
              _0x3ccfb1,
              {
                text: _0x1def38,
                ..._0x1bb9da,
                mentions: [darklove_bot.user],
              },
              {
                quoted: _0x919f26,
              }
        ...
        case "react":
          {
            return await darklove_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("DARKLOVE_MD");
    ...
    if (_0x1d4327) {
      ...
      if (_0x2d6cd0.quoted.message) {
        ...
        _0x2d6cd0.quoted.isBaileys = _0x2d6cd0.quoted.isBot =
          ...
          _0x2d6cd0.quoted.id?.startsWith("DARKLOVEMD") ||
