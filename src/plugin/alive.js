...
const alive = async (m, Matrix) => {
  ...
  if (['alive', 'uptime', 'runtime'].includes(cmd)) {
    ...
    const uptimeMessage = `*Dark-Love-𝙼𝙳 𝙸𝚂 𝙾𝙽𝙻𝙸𝙽𝙴*
╭❐
┇ *${days} Day(s)*
┇ *${hours} Hour(s)*
┇ *${minutes} Minute(s)*
    ...
    const buttons = [
      {
        ...
        "buttonParamsJson": JSON.stringify({
          display_text: "Dark-Love-MD -Menu",
          id: `${prefix}menu`
        })
      },
      {
        ...
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            footer: proto.Message.InteractiveMessage.Footer.create({
              text: "P𝚘𝚠𝚎𝚛𝚎𝚍 𝚋𝚢 Dark-Love-MD 'AY TECH"
            }),
            ...
            contextInfo: {
              ...
              forwardedNewsletterMessageInfo: {
                newsletterJid: '2348122441244@s.whatsapp.net',
                newsletterName: "Dark-Love-MD",
                serverMessageId: 143
              }
            }
          }),
