...
const text = m.body.slice(prefix.length + cmd.length).trim();
  ...
  if (validCommands.includes(cmd)) {
    ...
    try {
      await m.React('🕘');
      await m.reply('A moment, *Dark-Love-MD* is generating your lyrics request...');
        ...
        let buttons = [{
          ...
          },
          {
            ...
            buttonParamsJson: JSON.stringify({
              ...
              url: `https://whatsapp.com/channel/0029VaiBr1WDzgTAYG2f6V37`
            })
          },
          {
            name: "quick_reply",
            buttonParamsJson: JSON.stringify({
              display_text: " Dark-Love-MD Main Menu",
              id: ".menu"
            })
          }
        ];
