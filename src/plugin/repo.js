...
const alive = async (m, Matrix) => {
  ...
  if (['repo', 'sc', 'deploy'].includes(cmd)) {
    ...
    const uptimeMessage = `*_Dark-Love-𝙼𝙳 𝚁𝙴𝙿𝙾_*
╭❐
┇ Creator:AY TECH
┇ repo
...
┇
┇Get session id 
┇https://joetech1-b296fdeab001.herokuapp.com/pair
┇
╰❑
`;
    ...
    const buttons = [
      ...
      },
      {
        ...
        "buttonParamsJson": JSON.stringify({
          display_text: "𝙶𝚒𝚝𝙷𝚞𝚋",
          id: `https://github.com/ayodejibot/Dark-Love-MD/`
        })
      }
    ];
        ...
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            footer: proto.Message.InteractiveMessage.Footer.create({
              text: "P𝚘𝚠𝚎𝚛𝚎𝚍 B𝚢 Dark-Love-MD 'AY TECH"
            }),
