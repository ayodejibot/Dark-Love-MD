...
cmd({
  ...
  try {
    ...
    // Check update status
    let updateMessage = `✅ Your one and only Dark-Love-MD bot is up-to-date!`;
    if (localVersion !== latestVersion) {
      updateMessage = `🚀 Your Dark-Love-MD bot is outdated!
...
Use *.update* to update.`;
    ...
    const statusMessage = `🌟 *Good ${new Date().getHours() < 12 ? 'Morning' : 'Night'}, ${pushname}!* 🌟\n\n` +
      ...
      `📝 *Changelog:*\n${latestChangelog}\n\n` +
      `⭐ *GitHub Repo:* ${githubRepo}\n👤 *Owner:* [AY TECH](https://github.com/ayodejibot/Dark-Love-MD)\n\n${updateMessage}\n\n🚀 *Hey! Don't forget to fork & star the repo!*`;
