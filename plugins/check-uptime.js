...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        // Style 1: Classic Box
        const style1 = `╭───『 Dark-Love-MD UPTIME 』───⳹
│
│ ⏱️ ${uptime}
│
...
${config.DESCRIPTION}`;
        ...
        // Style 2: Minimalist
        const style2 = `•——[ Dark-Love-MD UPTIME ]——•
  │
  ├─ ⏳ ${uptime}
        ...
        await conn.sendMessage(from, { 
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'AY TECH',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
